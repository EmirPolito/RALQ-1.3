...
export const ProductCard = ({
  ...
  return (
    <motion.div
      style={{ x: translate }}
      whileHover={{ y: -20 }}
      className="group/product h-96 w-[30rem] relative shrink-0 cursor-default"
    >
      {/* Imagen sin enlace */}
      <img
        ...
        height="600"
        width="600"
        className="object-cover object-left-top absolute h-full w-full inset-0 select-none pointer-events-none"
        alt={product.title}
      />
